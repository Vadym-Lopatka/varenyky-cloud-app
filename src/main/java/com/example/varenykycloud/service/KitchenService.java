...
public class KitchenService {
    ...
    public void kitchenOrderHandler1(String orderId, Message<String> message) {
        log.info("order_listener_1_>>: {}", orderId);
    }

    @KafkaListener(topics = TOPIC_NAME, groupId = "orders2")
    public void kitchenOrderHandler2(String orderId, Message<String> message) {
        log.info("order_listener_2_>>: {}", orderId);
    }

    @KafkaListener(topics = TOPIC_NAME, groupId = "orders3")
    public void kitchenOrderHandler3(String orderId, Message<String> message) {
        log.info("order_listener_3_>>: {}", orderId);
    }

    @KafkaListener(topics = TOPIC_NAME, groupId = "orders4")
    public void kitchenOrderHandler4(String orderId, Message<String> message) {
